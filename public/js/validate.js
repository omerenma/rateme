$(document).ready(function(){
    $('#register').on('click', function(){
        var name = $.trim($('#name').val()); // Remove every white space with $.trim
        ...
        // If isValue == true ? create a new object and use ajax to send the object data to the server
        if(isValid == true){
            ...
            // Use jquery ajax to send the data to server
            $.ajax({
                url: '/company/create',
                type: 'POST',
                data: companyData,
